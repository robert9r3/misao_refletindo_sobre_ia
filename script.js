...
const perguntas = [
  {
    ...
    imagem: "./img/Ética no Uso de IA em trabalhos.png"
  },
  {
    enunciado:
    ...
    imagem: "./img/IA e o Futuro do Trabalho.png"
  },
  {
    enunciado:
    ...
    imagem: "./img/IA na Educação - Debate e Perspectivas.png"
  },
  {
    enunciado:
    ...
    imagem: "./img/Métodos de Pesquisa - IA vs tradicional.png"
  },
  {
    enunciado:
...
function mostraResultado(){
  ...
  caixaAlternativas.textContent = "";
caixaImagem.innerHTML = `<img src="./img/2049 - Futuro da IA.png" alt="O Futuro da IA em 2049" class="imagem-pergunta">`;
}
